...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="add product" name="thêm sản phẩm" class="btn">
   </form>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="admin_products.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('xóa sản phẩm?');">xóa</a>
      </div>
      <?php
         }
      }else{
